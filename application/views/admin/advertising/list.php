...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title"><?= $this->lang->line("admin_advertising_list_page_card_title"); ?></h6>
                    ...
                    <div class="table-responsive">
                        <table id="advertisingDataTable" class="table">
                            <thead>
                                <tr>
                                    <th><?= $this->lang->line("admin_advertising_list_page_table_id"); ?></th>
                                    <th><?= $this->lang->line("admin_advertising_list_page_table_image"); ?></th>
                                    <th><?= $this->lang->line("admin_advertising_list_page_table_title"); ?></th>
                                    <th><?= $this->lang->line("admin_advertising_list_page_table_location"); ?></th>
                                    <th><?= $this->lang->line("admin_advertising_list_page_table_status"); ?></th>
                                    <th><?= $this->lang->line("admin_advertising_list_page_table_created_at"); ?></th>
                                    <th><?= $this->lang->line("admin_advertising_list_page_table_updated_at"); ?></th>
                                        ...
                                        <td>
                                            <?php if ($advertising["status"]): ?>
                                                <span class="badge border border-success text-success">
                                                    <?= $this->lang->line("admin_advertising_list_page_status_enabled"); ?>
                                                </span>
                                            <?php else: ?>
                                                <span class="badge border border-secondary text-secondary">
                                                    <?= $this->lang->line("admin_advertising_list_page_status_disabled"); ?>
                                                </span>
                                            <?php endif; ?>
                                        </td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        ...
                                                        <span class="text-info">
                                                            <?= $this->lang->line("admin_advertising_list_page_control_view"); ?>
                                                        </span>
                                                    </a>
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        ...
                                                        <span class="text-warning">
                                                            <?= $this->lang->line("admin_advertising_list_page_control_edit"); ?>
                                                        </span>
                                                    </a>
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        href="javascript:void(0);" data-bs-toggle="modal"
                                                        data-bs-target="#deleteAdvertisingModal"
                                                        data-url="<?= base_url('admin/advertising/' . $advertising['id']) . '/delete'; ?>">
                                                        <i data-feather="trash" class="icon-sm text-danger me-2"></i>
                                                        <span class="text-danger">
                                                            <?= $this->lang->line("admin_advertising_list_page_control_delete"); ?>
                                                        </span>
                                                    </a>
                                                </div>
                                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:void(0);" id="deleteAdvertisingButton" class="btn btn-outline-danger">
...
<script>
    document.querySelectorAll("[data-bs-toggle='modal']").forEach(item => {
        item.addEventListener("click", function () {
            document.getElementById("deleteAdvertisingButton").href = this.getAttribute("data-url");
        });
    });
</script>
