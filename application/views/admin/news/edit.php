        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="<?= base_url('admin/news/' . $news['id'] . '/update'); ?>" method="POST"
                            ...
                            <div class="tab-pane fade show active" id="az" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title_az" id="title_az" class="form-control"
                                            value="<?= $news['title_az']; ?>" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description_az" id="short_description_az"
                                            ...
                                            required><?= $news['short_description_az']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="long_description_az" id="long_description_az"
                                            ...
                                            required><?= $news['long_description_az']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description_en" id="short_description_en"
                                            class="form-control" rows="3"
                                            required><?= $news['short_description_en']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="long_description_en" id="long_description_en"
                                            class="form-control" rows="10"
                                            required><?= $news['long_description_en']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description_ru" id="short_description_ru"
                                            class="form-control" rows="3"
                                            required><?= $news['short_description_ru']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="long_description_ru" id="long_description_ru"
                                            class="form-control" rows="10"
                                            required><?= $news['long_description_ru']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label"
                                        for="status"><?= $this->lang->line("status"); ?></label>
                                </div>
                            </div>
                        </div>
