                            ...
                            <div class="dropdown-menu dropdown-menu-end p-0">
                                <div class="p-1">
                                    <a class="dropdown-item py-2" href="javascript:void(0);">
                                        <img src="<?= base_url('public/admin/assets/images/brands/github.svg'); ?>"
                                            class="avatar-xs" alt="Github" />
                                        <span class="ms-2">GitHub:
                                            <span class="fw-medium">@reback</span></span>
                                    </a>
                                    <a class="dropdown-item py-2" href="javascript:void(0);">
                                        <img src="<?= base_url('public/admin/assets/images/brands/bitbucket.svg'); ?>"
                                            class="avatar-xs" alt="bitbucket" />
                                        <span class="ms-2">Bitbucket:
                                            <span class="fw-medium">@reback</span></span>
                                    </a>
                                    <a class="dropdown-item py-2" href="javascript:void(0);">
                                        <img src="<?= base_url('public/admin/assets/images/brands/dribbble.svg'); ?>"
                                            class="avatar-xs" alt="dribbble" />
                                        <span class="ms-2">Dribbble:
                                            <span class="fw-medium">@username</span></span>
                                    </a>

                                    <a class="dropdown-item py-2" href="javascript:void(0);">
                                        <img src="<?= base_url('public/admin/assets/images/brands/dropbox.svg'); ?>"
                                            class="avatar-xs" alt="dropbox" />
                                        <span class="ms-2">Dropbox:
                                            <span class="fw-medium">@username</span></span>
                                    </a>

                                    <a class="dropdown-item py-2" href="javascript:void(0);">
                                        <img src="<?= base_url('public/admin/assets/images/brands/slack.svg'); ?>"
                                            class="avatar-xs" alt="mail_chimp" />
                            ...
                            <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end"
                                ...
                                <div data-simplebar style="max-height: 280px">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('public/admin/assets/images/users/avatar-1.jpg'); ?>"
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('public/admin/assets/images/users/avatar-3.jpg'); ?>"
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('public/admin/assets/images/users/avatar-5.jpg'); ?>"
                            ...
                            <a type="button" class="topbar-button" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle" width="32"
                                        src="<?= base_url('public/admin/assets/images/users/avatar-1.jpg'); ?>"
                                        alt="avatar-3" />
                                </span>
                            </a>
            ...
            <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-activity-offcanvas"
                ...
                <div class="offcanvas-body p-0">
                    <div data-simplebar class="h-100 p-4">
                        <div class="position-relative ms-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <a href="pages-starter.html#!"
                                                            class="text-dark fw-medium">reback.docs</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <div
                                            ...
                                            <a href="pages-starter.html#!" class="fw-medium text-dark">UI/UX Figma
                                                Design</a>
                                            <div class="ms-auto">
                                                <a href="pages-starter.html#!" class="fw-medium text-primary fs-18"
                            ...
                            <div class="position-relative ps-4">
                                <div class="mb-4">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <div class="mt-2">
                                            <a href="pages-starter.html#!" class="btn btn-light btn-sm">Download Zip</a>
                                        </div>
                                        <h6 class="mt-3 text-muted">
                                            Monday , 2:10 PM
                                        </h6>
                                ...
                                <div class="mb-4">
                                    <span
                                        class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img
                                            src="<?= base_url('public/admin/assets/images/users/avatar-7.jpg'); ?>"
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <div class="row g-2 mt-2">
                                            <div class="col-lg-4">
                                                <a href="pages-starter.html#!">
                                                    <img src="<?= base_url('public/admin/assets/images/small/img-6.jpg'); ?>"
                                                        alt="" class="img-fluid rounded" />
                                                </a>
                                            </div>
                                            <div class="col-lg-4">
                                                <a href="pages-starter.html#!">
                                                    <img src="<?= base_url('public/admin/assets/images/small/img-3.jpg'); ?>"
                                                        alt="" class="img-fluid rounded" />
                                                </a>
                                            </div>
                                            <div class="col-lg-4">
                                                <a href="pages-starter.html#!">
                                                    <img src="<?= base_url('public/admin/assets/images/small/img-4.jpg'); ?>"
                                                        alt="" class="img-fluid rounded" />
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="position-relative ps-4">
                                <div class="mb-4">
                                    <span
                                        class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img
                                            src="<?= base_url('public/admin/assets/images/users/avatar-6.jpg'); ?>"
                                            alt="avatar-5" class="avatar-sm rounded-circle" /></span>
                                    <div class="ms-2">
                                        <h5 class="mb-0 text-dark fw-semibold fs-15 lh-base">
                        ...
                        <a href="pages-starter.html#!" class="btn btn-outline-dark w-100">View All</a>
                    </div>
                </div>
            </div>
        </div>
