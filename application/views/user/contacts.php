				...
				<div class="col-lg-7">
					<div class="contact-info">
						<div class="section-title">
							<h2 class="title mb-0"><i class="fa-solid fa-bolt-lightning"></i>Get in touch with us. We love talking about digital strategy</h2>
						</div>
						<div class="row">
				...
				<div class="col-lg-5 mt-5 mt-lg-0">
					<div class="form-info bg-light">
						...
						<form class="mt-4">
							...
							<div class="mb-4">
								<textarea class="form-control" id="exampleInputEnquiry-Description" placeholder="Please describe what you need" rows="7"></textarea>
							</div>
							<div class="mb-0">
			...
			<div class="row mt-5">
				<div class="col-lg-4 mb-4 mb-lg-0">
					<div class="contact-chat h-100">
						<h5 class="text-white">Chat to us online</h5>
						<p class="mb-0 text-white">Get our latest news straight into your inbox.</p>
						<div class="mb-0">
							<button type="submit" class="btn btn-primary">Start web chat</button>
						</div>
					</div>
				</div>
				<div class="col-lg-4 mb-4 mb-lg-0">
				...
				<div class="col-lg-4">
					<div class="contact-us h-100">
						<h5>Contact us now to lock rate</h5>
						<p class="mb-0">Please describe what you need Contact us now to lock in your rate.</p>
						<h4>(123) 345-6789</h4>
					</div>
				</div>
			</div>
