			...
			<div class="row">
				<div class="col-xl-3 col-lg-6 col-md-6 col-sm-7 mb-4">
					<div class="footer-about">
						<a class="footer-logo" href="index.html"><img class="img-fluid" src="<?= base_url('public/user/assets/images/logo-light.png'); ?>" alt="logo"></a>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 mb-4">
					...
					<div class="footer-post">
						<div class="blog-post">
							<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/blog/84.jpg'); ?>" alt=""> </div>
						...
						<div class="blog-post  mb-0">
							<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/blog/85.jpg'); ?>" alt=""> </div>
							<div class="blog-post-details">
				...
				<div class="col-xl-3 col-lg-6 col-md-6 mb-4">
					...
					<ul class="footer-insta">
						<li>
							<a href="#"><img class="img-fluid" src="<?= base_url('public/user/assets/images/instagram/06.jpg'); ?>" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span>
						</li>
						<li>
							<a href="#"><img class="img-fluid" src="<?= base_url('public/user/assets/images/instagram/07.jpg'); ?>" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span>
						</li>
						<li>
							<a href="#"><img class="img-fluid" src="<?= base_url('public/user/assets/images/instagram/08.jpg'); ?>" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span>
						</li>
						<li>
							<a href="#"><img class="img-fluid" src="<?= base_url('public/user/assets/images/instagram/09.jpg'); ?>" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span>
						</li>
						<li>
							<a href="#"><img class="img-fluid" src="<?= base_url('public/user/assets/images/instagram/10.jpg'); ?>" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span>
						</li>
						<li>
							<a href="#"><img class="img-fluid" src="<?= base_url('public/user/assets/images/instagram/11.jpg'); ?>" alt="#"></a> <span><i class="fa-brands fa-instagram "></i></span>
						</li>
					</ul>
				</div>
			</div>
