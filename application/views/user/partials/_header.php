					...
					<div class="col-12">
						<div class="d-lg-flex align-items-center text-center">
							...
							<div class="topbar-right ms-auto justify-content-center"> <span class="user">
									<a href="sign-in.html"><img src="<?= base_url('public/user/assets/images/user.png'); ?>" alt="#"> Sign In</a>
								</span>
								<div class="dropdown right-menu d-inline-flex news-language">
									<a class="dropdown-toggle" href="#" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="img-fluid country-flag" src="<?= base_url('public/user/assets/images/country-flags/02.jpg'); ?>" alt=""> English<i class="fas fa-chevron-down fa-xs"></i> </a>
									<div class="dropdown-menu mt-0" aria-labelledby="dropdownMenuButton2">
										<a class="dropdown-item" href="#"><img class="img-fluid country-flag" src="<?= base_url('public/user/assets/images/country-flags/02.jpg'); ?>" alt="">English</a>
										<a class="dropdown-item" href="#"><img class="img-fluid country-flag" src="<?= base_url('public/user/assets/images/country-flags/09.jpg'); ?>" alt="">Francais</a>
										<a class="dropdown-item" href="#"><img class="img-fluid country-flag" src="<?= base_url('public/user/assets/images/country-flags/11.jpg'); ?>" alt="">Deutsch</a>
										<a class="dropdown-item" href="#"><img class="img-fluid country-flag" src="<?= base_url('public/user/assets/images/country-flags/12.jpg'); ?>" alt="">Italiano</a>
									</div>
								</div>
	...
	<nav class="navbar navbar-expand-lg">
		<div class="container position-relative">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav">
					<li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown01" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									...
									<div class="row">
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/technology/menu/01.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-primary">Vehicle</span>
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/technology/menu/02.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-blue">Touchless</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/technology/menu/03.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-red">Gadgets</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/technology/menu/04.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-yellow">Earbuds</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/technology/menu/05.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-red">eyeprint</span>
												<div class="blog-post-details">
							...
							<li class="nav-item">
								...
								<div class="inner-mega-menu">
									<div class="row">
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image">
													<img class="img-fluid" src="<?= base_url('public/user/assets/images/category/sport/menu/01.jpg'); ?>" alt="">
												</div>
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/sport/menu/02.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-primary">Pool</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/sport/menu/03.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-purple">Rugby</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/sport/menu/04.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-red">Boxing</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/sport/menu/05.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-yellow">Volleyball</span>
												<div class="blog-post-details">
							...
							<li class="nav-item">
								...
								<div class="inner-mega-menu">
									<div class="row">
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/entertainment/menu/01.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-orange">Nightclubs</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/entertainment/menu/02.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-blue">Dance</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/entertainment/menu/03.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-primary">Music</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/entertainment/menu/04.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-red">Movies</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/entertainment/menu/05.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-purple">Video Games</span>
												<div class="blog-post-details">
							...
							<li class="nav-item">
								...
								<div class="inner-mega-menu">
									<div class="row">
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/politician/menu/01.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-primary">Lider</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/politician/menu/02.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-red">Politician</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/politician/menu/03.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-blue">Events</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/politician/menu/04.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-pink">People</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/politician/menu/05.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-yellow">Candidates</span>
												<div class="blog-post-details">
							...
							<li class="nav-item">
								...
								<div class="inner-mega-menu">
									<div class="row">
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/magazine/menu/01.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-primary">Fashion</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/magazine/menu/02.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-red">Travel</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/magazine/menu/03.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-skyblue">Photography</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/magazine/menu/04.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-orange">Model</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/magazine/menu/05.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-purple">Style</span>
												<div class="blog-post-details">
							...
							<li class="nav-item">
								...
								<div class="inner-mega-menu">
									<div class="row">
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/life-style/menu/01.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-skyblue">Lifestyle</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/life-style/menu/02.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-orange">Fashion</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/life-style/menu/03.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-red">Beauty</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/life-style/menu/04.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-blue">Model</span>
												<div class="blog-post-details">
										...
										<div class="col">
											<div class="blog-post post-style-02 mb-3">
												<div class="blog-image"> <img class="img-fluid" src="<?= base_url('public/user/assets/images/category/life-style/menu/05.jpg'); ?>" alt=""> </div> <span class="badge badge-large bg-purple">Style</span>
												<div class="blog-post-details">
